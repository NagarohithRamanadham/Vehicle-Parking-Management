						...
						<div class="col-md-12">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="APXXDPXXXX" id="vehreno" name="vehreno" required>
								</div>


								<div class="form-group">
									<label>Vehicle's Company Name</label>
									<input type="text" class="form-control" placeholder="Maruthi Suzuki" id="vehcomp" name="vehcomp" required>
								</div>
